...
const Banner = () => {
    return (
        <div className="my-10 md:my-20 w-11/12 mx-auto flex flex-col-reverse md:flex-row justify-between items-center gap-x-10">
            <div className='text-center md:text-left'>
                ...
                <p className='my-5 text-dark3 lg:w-2/3 text-sm lg:text-base'>Explore thousands of job opportunities with all the information you need. Its your future. Come find it. Manage all your job application from start to finish.</p>
